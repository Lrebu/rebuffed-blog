...
export const siteConfig: SiteConfig = {
	title: "rebuffed blog",
	subtitle: "懒人blog",
	siteURL: "https://blog.rebuffed.cloud/", // 请替换为你的站点URL，以斜杠结尾
	siteStartDate: "2026-02-27", // 站点开始运行日期，用于站点统计组件计算运行天数
	...
	banner: {
		...
		homeText: {
			...
			title: "rebuffed blog", // 主页横幅主标题

			subtitle: [
				"天下之大，非一人之天下。——《一人之下》",
				"天下熙熙，皆为利来；天下攘攘，皆为利往。——《天行九歌》",
				"凡王之血，必以剑终。——《龙族》",
				"我重临世界之日，诸逆臣皆当死去。——《龙族》",
				"苍生涂涂，天下缭缭，诸子百家，唯我纵横。——《秦时明月》",
			],
			typewriter: {
...
export const announcementConfig: AnnouncementConfig = {
	...
	content: "本博客主要记录学习电控和Linux的学习日志,不定时开源项目", // 公告内容
